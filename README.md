...
- `GET /`、`GET /health` 使用统一响应信封
- `POST /oauth2/token`、`POST /oauth2/introspect` 保持 OAuth/OIDC 兼容响应
- OAuth 错误响应会额外附带 `display_message`、`trace_id`、`timestamp`
...
- 统一接口设计稿：`docs/proxy-api-design.md`
